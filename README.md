...
Setup:
  ...
  I will not explain the install for a plex server, record your username, password and the name given to the plex server, something like HOME-SERVER. install on same device as radarr and sonarr
